...
%let xlabel=Antall pr. 1 000 vaginale førstegangsfødsler.;
...
%let xlabel=Antall pr. 1 000 vaginale flergangsfødsler.;
%let formattabell=&tabellvar1 NLnum8.0 &tabellvar2 NLnum8.0;
%let skala=;
...
%let xlabel=Antall pr. 1 000 keisersnitt førstegangsfødsler.;
%let formattabell=&tabellvar1 NLnum8.0 &tabellvar2 NLnum8.0;
%let skala=;
...
%let xlabel=Antall pr. 1 000 keisersnitt flergangsfødsler.;
%let formattabell=&tabellvar1 NLnum8.0 &tabellvar2 NLnum8.0;
%let skala=;
...
%let tabellvariable= &tabellvar1 &tabellvar2;
%let labeltabell=&tabellvar1="&tema" &tabellvar2="vaginale førstegangsfødsler";
%let xlabel=Antall pr. 1 000 vaginale førstegangsfødsler spontan;
%let formattabell=&tabellvar1 NLnum8.0 &tabellvar2 NLnum8.0;
%let skala=;
...
%let tabellvariable= &tabellvar1 &tabellvar2;
%let labeltabell=&tabellvar1="&tema" &tabellvar2="vaginale førstegangsfødsler";
%let xlabel=Antall pr. 1 000 vaginale førstegangsfødsler igangsatt;
%let formattabell=&tabellvar1 NLnum8.0 &tabellvar2 NLnum8.0;
%let skala=;
...
%let tabellvariable= &tabellvar1 &tabellvar2;
%let labeltabell=&tabellvar1="&tema" &tabellvar2="vaginale flergangsfødsler";
%let xlabel=Antall pr. 1 000 vaginale flergangsfødsler spontan;
%let formattabell=&tabellvar1 NLnum8.0 &tabellvar2 NLnum8.0;
%let skala=;
...
%let tabellvariable= &tabellvar1 &tabellvar2;
%let labeltabell=&tabellvar1="&tema" &tabellvar2="vaginale flergangsfødsler";
%let xlabel=Antall pr. 1 000 vaginale flergangsfødsler igangsatt;
%let formattabell=&tabellvar1 NLnum8.0 &tabellvar2 NLnum8.0;
%let skala=;
