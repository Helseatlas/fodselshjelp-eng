...
%let xlabel=Antall vaginal med blødning 1500ml+, pr. 1 000 fødsler;
...
%let tabellvariable= &tabellvar1 &tabellvar2;
%let labeltabell=&tabellvar1="&tema" &tabellvar2="alle fødsler";
%let xlabel=Antall keisersnitt med blødning 1500ml+, pr. 1 000 fødsler;
%let formattabell=&tabellvar1 comma8.0 &tabellvar2 comma8.0;
%let skala=;
...
%let fignavn=vagks;
%let type=;
%let tittel=Blødning 1500ml+;
%let xlabel= Antall blødning 1500ml+ pr. 1 000 fødsler;
%let label_1=vag;
%let label_2=ks;
