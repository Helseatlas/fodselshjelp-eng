...
%legg_til_datasett(dsn=anestesi_vagp0vag_ijust_bohf, original=datasett, utv=epidural);
%legg_til_datasett(dsn=episiotomip0_ijust_bohf, original=datasett, utv=klipp);
%legg_til_datasett(dsn=indusertp0_ijust_bohf, original=datasett, utv=indusert);
...
ODS Graphics ON / imagemap reset=All imagename="scatter_inngrep_vag_p0" imagefmt=png  border=off width=14.0cm height=10.0cm;
