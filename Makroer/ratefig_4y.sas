...
/*enkel ratefigur*/
%macro ratefig_4y(datasett=, aar1=2014, aar2=2015, aar3=2016, aar4=2017, bildeformat=png, noxlabel=0, bohf_format=BoHF_kort,sprak=no);
...
if &rv1 lt &nkrav then do;
     ratesnitt=.;
	 rate&aar1=.; rate&aar2=.; rate&aar3=.; rate&aar4=.;min=.; max=.;
     Mistext="N<&nkrav";
...
bohf&aar3=bohf;
bohf&aar4=bohf;
label bohf&aar1="&aar1" bohf&aar2="&aar2" bohf&aar3="&aar3" bohf&aar4="&aar4";
format bohf&aar1 bohf&aar2 bohf&aar3 bohf&aar4 &bohf_format..;
...
%if &vis_aarsvar=1 %then %do;
	...
	scatter x=rate&aar4 y=Bohf&aar4 / markerattrs=(symbol=X            color=CX00509E size=6pt) name="y4"; 
	...
	keylegend "y1" "y2" "y3" "y4"/ across=1 position=bottomright location=inside noborder valueattrs=(size=7pt);
	%end;
%end;
